...
export default class PATFStepperMDP extends FTaskStepperMDP {
    ...
    constructor({ taskRoot }: { taskRoot: any }) {
        super({ myRefName: "prepareAmendmentStepperRef",actionable: !taskRoot.taskDisabled,linearProgress: true });
        ...
        addStep({
            name: "Creditor",
            stepContent: new PATCreditorStepFCreditorMDP({parent: this, taskRoot: this.taskRoot})
        }).
        addStep({
            name: "Payment Plan",
            stepContent: new PATPPFAPaymentPlanMDP({parent: this, taskRoot: this.taskRoot})
        }).
        addStep({
            name: "Mark Complete",
