...
import OPRCreditorSettledListFDataTableMDP from './OPRCreditorSettledListFDataTableMDP';
@Component({
  components:{
    FDataTable,
    // MySettlementFTab
...
export default class OPRCreditorSettledList extends Vue {
  ...
  get fiCreditorSettledListFDataTableMDP() {
    return new OPRCreditorSettledListFDataTableMDP({
      parent: this,
    }).getMetaData();
  }
