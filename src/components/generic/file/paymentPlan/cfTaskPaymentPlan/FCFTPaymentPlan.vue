...
import FCFTPPScheduleFDataTableMDP from "./FCFTPPScheduleFDataTableMDP";
import FCFTPSkipedPresentedFDataTableMDP from "./FCFTPSkipedPresentedFDataTableMDP";
import FCFTFeeFDataTableMDP from "./FCFTFeeFDataTableMDP";
import AddCFTPsEntryFFormMDP from "./AddCFTPsEntryFFormMDP";
import FCFTPaymentFDataTableMDP from "./FCFTPaymentFDataTableMDP";
...
export default class FCFTPaymentPlan extends ModelVue {
  ...
  get fPaymentScheduleFDataTableMetaData() {
    return new FCFTPPScheduleFDataTableMDP({
      parent: this,
  ...
  get fcfPaymentTableMetaData() {
    return new FCFTPaymentFDataTableMDP({ parent: this }).getMetaData();
  }
  ...
  get fFeeFDataTableMetaData() {
    return new FCFTFeeFDataTableMDP({ parent: this }).getMetaData();
  }

  get addPsEntryFFormMetaData() {
    return new AddCFTPsEntryFFormMDP({
      parent: this,
    }).getMetaData();
  }
