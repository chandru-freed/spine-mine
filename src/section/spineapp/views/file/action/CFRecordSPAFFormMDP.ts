...
export default class CFRecordSPAFFormMDP extends FFormMDP {
  ...
  createUser() {
    return () => {
      this.getMyRef().submitForm(() => {
        this.parent.recordSPAPaymentInput.clientFileId = this.parent.clientFileId;
        Action.ClientFile.RecordSPAPayment.execute(this.parent.recordSPAPaymentInput, (output) => {
          this.parent.gotoCFPayment();
          FSnackbar.success("Successfully recorded the spa payment");
        });
      })
    }
  }
