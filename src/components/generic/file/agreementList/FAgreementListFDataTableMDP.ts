...
import FCellBtnMDP from "../../table/cell/FCellBtnMDP";
import FCellBtnPreviewMDP from "../../table/cell/FCellBtnPreviewMDP";
export default class FAgreementListFDataTableMDP extends FDataTableMDP {
  parent: any;
  constructor(props: { parent: any; taskRoot: any }) {
    super({
      myRefName: "fAgreementListFDataTableMDP",
  ...
  handleGenerateLink() {
    return () => {
      return new Promise((res) => {
        Action.ClientFile.GenerateAgreement.execute1(
