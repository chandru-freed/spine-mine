<template>
  <div class="CFPaymentPlanMSFInfo">
    <component
...
import CFPaymentPlanMSFInfoFPPMSFInfoMDP from "./CFPaymentPlanMSFInfoFPPMSFInfoMDP";

import FCFPaymentPlanMSF from "@/components/generic/file/paymentPlan/cfPaymentPlan/FCFPaymentPlanMSF.vue";
...
export default class CFPaymentPlanMSFInfo extends ModelVue {
  ...
  get paymentPlanInfoMetaData() {
    return new CFPaymentPlanMSFInfoFPPMSFInfoMDP({
      taskRoot: this,
      parent: this,
    }).getMetaData();
  }
