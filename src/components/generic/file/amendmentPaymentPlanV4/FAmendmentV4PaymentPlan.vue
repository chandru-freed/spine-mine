...
import FPaymentScheduleFDataTableMDP from "./FPaymentScheduleV4FDataTableMDP";
import FDataTable from "../../table/FDataTable.vue";
import FPSkipedPresentedFDataTableMDP from "./FPSkipedPresentedV4FDataTableMDP";
import FFeeFDataTableMDP from "./FFeeV4FDataTableMDP";
import AddPsEntryFFormMDP from "./AddPsEntryV4FFormMDP";
import ModifyPsEntryFFormMDP from "./ModifyPsEntryV4FFormMDP";
...
export default class FAmendmentV4PaymentPlan extends ModelVue {
  tab = 0;
  ...
  modifyAmountPSEListInput: Data.ClientFile.ModifyAmountWithFixedTenureInput = new Data.ClientFile.ModifyAmountWithFixedTenureInput();
  ...
  resetFormsTableAndData() {
    ...
    this.modifyAmountPSEListInput = new Data.ClientFile.ModifyAmountWithFixedTenureInput();
