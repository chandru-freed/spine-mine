...
import CFRejectFileFFormMDP from "./CFRejectFileFFormMDP";
...
export default class CFRejectFile extends ModelVue {
  ...
  get cfRejectFileFFormMetaData() {
    return new CFRejectFileFFormMDP({ parent: this }).getMetaData();
  }
