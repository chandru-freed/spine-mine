<template>
  <div class="CFUpdateClientDetails">
...
import CFUpdateClientDetailsFFormMDP from "./CFUpdateClientDetailsFFormMDP";
...
export default class CFUpdateClientDetails extends ModelVue {
  ...
  get cfUpdateClientDetailsMetaData() {
    return new CFUpdateClientDetailsFFormMDP({ taskRoot: this }).getMetaData();
  }
  //METADATA
