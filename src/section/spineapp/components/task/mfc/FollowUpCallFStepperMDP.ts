...
export default class FollowUpCallFStepperMDP extends FStepperMDP {
    ...
    constructor({ taskRoot }: { taskRoot: ManualTaskIntf }) {
        ...
        this.addStep({ name: "Call", stepContent: new FUCTFFormMDP({ taskRoot: taskRoot, parent: this }) })
        .addStep({name: "Mark Complete", stepContent: new FUCTFinalFFormMDP({ taskRoot: taskRoot, parent: this })})
    }
