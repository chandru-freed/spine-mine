import { ComponentMetaDataProvider, FormMetaData } from "@/../src-def/form/FormComponentDef";
...
export class StepMetaData implements ComponentMetaDataProvider {
  componentName = "v-step";
  id: string;
  name: string;
  ...
  componentMetaData() {
    return {
      props: {
        id: this.id,
        name: this.name,
        componentMetaData: this.component.componentMetaData
      },
    };
  }
}
