...
import SSATFStepperMDP from "@/section/spineapp/components/task/enrollment/signServiceAgreement/SSATFStepperMDP";
...
export default class SignServiceAgreementTask
  extends ModelVue
  implements FlowTaskIntf
{
  ...
  //Task Output
  taskFormOutputLocal: any = new Data.Spine.SignServiceAgreementTaskOutput();
