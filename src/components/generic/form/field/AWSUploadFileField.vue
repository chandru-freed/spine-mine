...
export default class AWSUploadFileField extends Vue {
  // MODEL VALUE - START
  @Prop()
  value: any;
  ...
  handlePostUploadFile() {
    ...
    const input = Data.Spine.AttachUploadedDocumentInput.fromJson(
      this.uploadedDocument
    );
    input.documentRefId = this.clientFileBasicInfo.clientFileId;
    Action.Spine.AttachUploadedDocument.execute(input, (output) => {
      this.uploadedDocument.fiDocumentId = output.documentId;
