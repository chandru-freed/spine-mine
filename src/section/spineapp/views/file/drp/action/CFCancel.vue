<template>
  <div class="CFUpdateContactInfo">
    <div class="d-flex justify-space-between align-center mx-5">
      ...
      <component
      v-if="!!cfCancelFFormMetaData"
      :ref="cfCancelFFormMetaData.myRefName"
      :is="cfCancelFFormMetaData.componentName"
      :value="selectModel(cancelInput, undefined)"
      @input="(newValue) => updateModel(cancelInput, newValue, undefined)"
      v-bind="cfCancelFFormMetaData.props"
    ></component>
  </div>
  <!--  TASK TAB -->
</template>
...
import CFCancelFFormMDP from './CFCancelFFormMDP'
...
export default class CFCancel extends ModelVue {
  ...
  get cfCancelFFormMetaData() {
          return new CFCancelFFormMDP({parent: this}).getMetaData()
}
