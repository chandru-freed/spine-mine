...
export default class FDocumentCHPP extends ModelVue {
  @Store.Getter.ClientFile.ClientFileSummary.clientFileBasicInfo
  clientFileBasicInfo: Data.ClientFile.ClientFileBasicInfo;

  uploadDocumentFormLocal = new Data.ClientFile.UploadDocumentForm();
  ...
  get uploadDocumentForm() {
    this.uploadDocumentFormLocal.docType = "CHPP";
    return this.uploadDocumentFormLocal;
  }

  set uploadDocumentForm(newValue) {
    this.uploadDocumentFormLocal = newValue;
  }
