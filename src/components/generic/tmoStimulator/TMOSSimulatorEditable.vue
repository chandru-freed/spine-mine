...
import TMOSSimulatorEditableFFormMDP from "./TMOSSimulatorEditableFFormMDP";
...
export default class TMOSSimulatorEditable extends ModelVue {
  ...
  get tmoStimulatorFormMetaData() {
    return new TMOSSimulatorEditableFFormMDP({
      taskRoot: this,
    }).getMetaData();
  }
