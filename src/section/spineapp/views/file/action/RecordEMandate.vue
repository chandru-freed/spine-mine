<template>
  <div class="RecordMSFPayment">
      ...
      <component
        ...
        @input="(newValue) => updateModel(addEmandateInput, newValue, undefined)"
...
addEmandateInput: Data.ClientFile.AddEMandateInput = new Data.ClientFile.AddEMandateInput();
 get cfAddEmandateFFormMetaData() {
  ...
  gotoCFEMandate() {
   ...
   populateBankDetails(details: any) {
    ...
    this.addEmandateInput.bankAddress.addressLine1 =
      details.ADDRESS;
