        ...
        <v-list class="py-0">
          <v-list-item dense>
            ...
            <v-list-item-action>
              ...
              <div class="d-flex">
              <v-chip x-small class="mx-2" v-if="!fileSummary.isFirstMSFPaid" color="warning" outlined>FMSF Not Paid</v-chip>
              <v-chip x-small class="mx-2" v-if="fileSummary.isFirstMSFPaid" color="green" outlined>FMSF Paid</v-chip>
