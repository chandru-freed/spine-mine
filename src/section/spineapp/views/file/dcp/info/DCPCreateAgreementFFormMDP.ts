...
import FBtnMDP from "@/components/generic/FBtnMDP";
      ...
      export default class DCPCreateAgreementFFormMDP  extends FFormMDP {
          ...
          handleGenerateClick() {
            return () => {
                const input: Data.DCPClientFile.GenerateAgreementFromExcelInput = Data.DCPClientFile.GenerateAgreementFromExcelInput.fromJson(this.parent.generateAgreementFromExcelInput);
                input.clientFileId = this.parent.clientFileId;
                Action.DCPClientFile.GenerateAgreementFromExcel.execute(input, output => {
