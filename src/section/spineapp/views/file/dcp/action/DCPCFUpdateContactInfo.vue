<template>
  <div class="DCPCFUpdateContactInfo">
...
import DCPCFUpdateContactInfoFFormMDP from "./DCPCFUpdateContactInfoFFormMDP";
...
export default class DCPCFUpdateContactInfo extends ModelVue {
  ...
  get cfUpdateContactInfoMetaData() {
    return new DCPCFUpdateContactInfoFFormMDP({ taskRoot: this }).getMetaData();
  }
  //METADATA
